    ...
    const addOpciones=this.props.vehic.armamento.forEach(
      (value,index)=>{
        var arma=<div key={value.nombre+value.opcionEscogida}>
          <OpcionArma nombre={value.nombre} opciones={this.props.vehic.armamento[index].opciones} opcionEscogida={this.props.vehic.armamento[index].opcionEscogida} unit={this.props.unidad} opcion={index}
